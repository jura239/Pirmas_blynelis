...
enemy1 = Person("Magus", 5000, 701, 525, 25, enemy_spells, [])
...
while running:
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            print(enemy.name + " attacks " + players[target].name.replace(":", "") + " for", enemy_dmg)
            ...
            if spell.type == "white":
                ...
                print(bcolors.OKBLUE + spell.name + " heals " + enemy.name + " for", str(magic_dmg), "points of damage" + bcolors.ENDC)
            elif spell.type == "black":
